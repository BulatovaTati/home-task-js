...
// // Переопредели значения переменных pricePerItem и
// // productName после их объявления.
...
// // ........................................5
// // ШАБЛОННЫЕ СТРОКИ
// // Объяви перемнную message и запиши в неё сообщение о покупке, строку
// //  в формате: "You picked <имя товара>, price per item is <цена товара> credits".Где < имя товара > и < цена товара > это значения переменных productName и pricePerItem.
...
// message = ordered > available ? "Not enough goods in stock!" : message = "Order is processed, our manager will contact you.";
// console.log(message);
...
// if(customerCredits >= orderedQuantity * pricePerDroid){
//   message = `You ordered ${orderedQuantity} droids, you have ${customerCredits - (orderedQuantity * pricePerDroid)} credits left`;
// }
